  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-between font-sans">
      ...
      <main className="flex-1 flex flex-col justify-center py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center animate-slide-up">
          ...
          <p className="mt-6 text-base text-slate-500 max-w-2xl mx-auto leading-relaxed">
            Nunca mais perca o prazo de uma vacina. MeuPetDigital ajuda você a
            gerenciar a saúde preventiva do seu pet, calcular próximas doses e
            manter o histórico vacinal sempre à mão.
          </p>
        ...
        <div className="mx-auto max-w-5xl mt-20 grid grid-cols-1 gap-8 sm:grid-cols-3">
          <div className="animate-fade-in bg-white rounded-2xl p-6 border border-slate-100 shadow-sm transition-all hover:shadow-md hover:-translate-y-1">
            ...
            <p className="mt-2 text-xs text-slate-500 leading-relaxed">
              Visualize de forma rápida e intuitiva a saúde de todos os seus
              cães através de indicadores de vacinas em dia, próximas e
              atrasadas.
            </p>
          </div>

          <div
            className="animate-fade-in bg-white rounded-2xl p-6 border border-slate-100 shadow-sm transition-all hover:shadow-md hover:-translate-y-1"
          ...
          >
            ...
            <p className="mt-2 text-xs text-slate-500 leading-relaxed">
              O sistema calcula automaticamente a data sugerida para a próxima
              dose de reforço anual de cada vacina aplicada.
            </p>
          </div>
          ...
          >
            ...
            <p className="mt-2 text-xs text-slate-500 leading-relaxed">
              Privacidade em primeiro lugar. Suas informações de pets e
              registros vacinais estão totalmente isoladas e seguras por tutor.
            </p>
          </div>
        </div>
      </main>
      ...
      <footer className="border-t border-slate-200 bg-white py-6">
        <div className="mx-auto w-full max-w-[1920px] px-4 sm:px-6 lg:px-8 text-center text-xs text-slate-400 font-medium">
          © {new Date().getFullYear()} MeuPetDigital. Desenvolvido para a
